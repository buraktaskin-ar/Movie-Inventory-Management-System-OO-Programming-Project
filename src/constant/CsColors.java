...
/*
Bu CsColors sınıfı, konsol ekranında renkli metin yazdırmak için kullanılan 
renk kodlarını içeren bir sabitler sınıfıdır. 
Renk kodları, ANSI escape kodları kullanılarak tanımlanmıştır.
*/
